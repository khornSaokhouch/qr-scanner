...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100 overflow-hidden selection:bg-indigo-500 selection:text-white">
      {/* Background Radial Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-indigo-600/20 blur-[140px] rounded-full pointer-events-none" />
      ...
      <nav className="relative z-10 max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight text-white">SmartScan</span>
        </div>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pt-16 pb-24 flex flex-col items-center text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 backdrop-blur-md mb-8">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold tracking-tight max-w-3xl leading-[1.1]">
          Scan <span className="bg-gradient-to-r from-indigo-400 via-violet-300 to-sky-400 bg-clip-text text-transparent">Anything</span>.{" "}
          Anywhere.
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          ...
          <a
            href="#features"
            className="inline-flex items-center justify-center px-7 py-4 w-full sm:w-auto rounded-xl font-medium text-slate-300 hover:text-white hover:bg-slate-900 border border-slate-800 transition-colors"
          >
            How it Works
          </a>
        </div>
        ...
        <div className="mt-16 w-full max-w-md relative p-1 rounded-2xl bg-gradient-to-b from-indigo-500/20 to-transparent">
          <div className="relative aspect-[4/3] rounded-xl bg-slate-900/90 border border-slate-800 flex items-center justify-center overflow-hidden shadow-2xl backdrop-blur-sm">
            {/* Viewfinder Corner Brackets */}
            <div className="absolute top-4 left-4 w-6 h-6 border-t-2 border-l-2 border-indigo-400 rounded-tl-sm" />
            <div className="absolute top-4 right-4 w-6 h-6 border-t-2 border-r-2 border-indigo-400 rounded-tr-sm" />
            <div className="absolute bottom-4 left-4 w-6 h-6 border-b-2 border-l-2 border-indigo-400 rounded-bl-sm" />
            <div className="absolute bottom-4 right-4 w-6 h-6 border-b-2 border-r-2 border-indigo-400 rounded-br-sm" />
            ...
            <div className="text-center px-4">
              ...
              <p className="text-xs font-mono uppercase tracking-widest text-slate-400">Ready to Capture</p>
            </div>
          </div>
        </div>
        ...
        <div id="features" className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 w-full text-left">
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800/80">
            <h3 className="font-semibold text-white">Instant QR & Barcodes</h3>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800/80">
            <h3 className="font-semibold text-white">Document OCR</h3>
            <p className="mt-2 text-sm text-slate-400">
